...
#define LeftDirectPin2  8   //Left Motor direction pin 1 to MODEL-X IN4 
                                                                                //below are original remote values, changed to DVD remote using IRremote_Test.ino code
 #define IR_ADVANCE       0xD04CFC60       //code from IR controller "▲" button  00FF18E7
 #define IR_BACK          0x61DB14E2       //code from IR controller "▼" button  00FF4AB5
 #define IR_RIGHT         0x6F89644        //code from IR controller ">" button   00FF5AA5
 #define IR_LEFT          0x72726A46       //code from IR controller "<" button   00FF10EF
 #define IR_STOP          0x20464B24       //code from IR controller "OK" button  00FF38C7
 #define IR_turnsmallleft 0xCA8FB328       //code from IR controller "#" button   00FFB04F
